...
<head lang="en">
    ...
    <style>
        ...
        .footer{position:absolute;bottom:0;bottom:-25px;width:100%;height:100px;}
    </style>
</head>
<body>
        ...
        <div class="am-g">
            <div class="col-lg-6 col-md-8 col-sm-centered">
                ...
                <div class="am-form-group">
                    <div class="col-sm-12">
                        <div style="width: 38px;height: 38px;float: left;">
                            <img src="assets/i/account.png" style="width: 2rem;height: 2rem;margin: 0.8rem 0.8rem 0.8rem 0.8rem;">
                        </div>
                        <input type="text" id="phoneNum" name="phoneNum" placeholder="请输入账号">
                    </div>
                </div>
                ...
                <div class="am-form-group">
                    <div class="col-sm-12">
                        <div style="width: 38px;height: 38px;float: left;">
                            <img src="assets/i/password.png" style="width: 2rem;height: 2rem;margin: 0.8rem 0.8rem 0.8rem 0.8rem;">
                        </div>
