        ...
        <div class="col-lg-10">
            <form class="form-horizontal" method="post" action="${base}/accessToken">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="client_id" name="client_id" value="oauth_clientid_aligenie">
                    </div>
                </div>
                <div class="form-group">
                    <label for="client_secret" class="col-sm-4 control-label">应用secret</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="client_secret" name="client_secret" value="oauth_clientid_aligenie">
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="col-lg-10">
            <form class="form-horizontal" method="post" action="/accessToken">
                <div class="form-group">
                    <label for="client_id" class="col-sm-4 control-label">应用id</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="client_id" name="client_id" value="oauth_clientid_Aligen">
                    </div>
                </div>
                <div class="form-group">
                    <label for="client_secret" class="col-sm-4 control-label">应用secret</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="client_secret" name="client_secret" value="oauth_clientid_Aligen">
                    </div>
                </div>
                <div class="form-group">
                    <label for="grant_type" class="col-sm-4 control-label">grant_type</label>
    ...
    <div class="row marketing">
        <div class="col-lg-10">
            <form class="form-horizontal" method="post" action="/accessToken">
                ...
                <p style="text-align:center;"> 地图应用:map_application  &nbsp;&nbsp;&nbsp;&nbsp;  语音和语义应用:voice_application</p>
            </form>
        </div>
    </div>
</div>
